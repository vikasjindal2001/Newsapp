...
const getdata= async ()=>{
    await fetch('https://newsapi.org/v2/top-headlines?country=in&apiKey=5b756322ee95471290a01ccbd9894eb1&category=sports').then(res=> res.json()).then(data => setdata(data.articles))    
}
